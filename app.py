...
for linha in pagina_clientes.iter_rows(min_row=2,values_only=True):
    ...
    #2 - Entro no site https://consultcpf-devaprender.netlify.app/ e uso o cpf da planikha para pesquisar o status do pagamento daquele cliente
